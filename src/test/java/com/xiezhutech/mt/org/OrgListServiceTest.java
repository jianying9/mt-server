 ...
 * @author jianying9
 */
public class OrgListServiceTest extends AbstractServerTest {

    public OrgListServiceTest() {
    }
    ...
    public void check() {
        ...
        Response response = testHandler.execute(RouteNames.ORG_LIST_V1, paramMap);
    }
}
