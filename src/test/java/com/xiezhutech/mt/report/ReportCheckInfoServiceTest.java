...
public class ReportCheckInfoServiceTest extends AbstractServerTest {

    public ReportCheckInfoServiceTest() {
    }
    ...
    public void test02UserList() {
        ...
        Response response = testHandler.execute(RouteNames.REPORT_CHECK_INFO_V1, paramMap);
    }
