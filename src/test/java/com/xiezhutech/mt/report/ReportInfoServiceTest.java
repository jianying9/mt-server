...
public class ReportInfoServiceTest extends AbstractServerTest {

    public ReportInfoServiceTest() {
    }
    ...
    public void test02UserList() {
        ...
        Response response = testHandler.execute(RouteNames.REPORT_INFO_V1, paramMap);
    }
