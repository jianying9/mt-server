 ...
 * @author jianying9
 */
public class GcRzDaileiGjModelHandlerImpl extends AbstractModelHandler implements ModelHandler {
    ...
    public void fillModel(Map<String, Object> modelMap) {
        ...
        //反向弯曲性能
        int fxwqCheckNum = this.getCheckNum(modelMap, "fxwqCheckNum");
        if (fxwqCheckNum > 0) {
            num = num + fxwqCheckNum;
            pay = pay + fxwqCheckNum * 300;
        }
        //化学成分
